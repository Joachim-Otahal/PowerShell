...
As you can see: It works in a real shell. I cannot install Visual Studio and other things on customers servers just to work around this bug. We, the admins, still have to rely on Powershell_ISE.
